...
;=================================================================			
        ...
        proc MainBoard
            ...
            ;Put First Apple
                call Random_Values
                Random_Into_Variables
                PrintSnake [randX],[randY],[endRandX],[endRandY],4
		...
		proc setSnakeColor
			...
			set_Cursor_Position 4,107
			Print_String instruc_design
			set_Cursor_Position 21,45
			Print_String Press_Enter
		;Draw Snake for showing examples for user
			mov [x1],40
			mov [x2],45
			mov [y1],60 
			mov [y2],140 
			PrintSnake [x1],[y1],[x2],[y2],[colorsnake]
		...
		endp setSnakeColor
;=================================================================
                ;DrawGvolot Procedure - Drawing Game Borders   
;=================================================================
        proc DrawGvolot
			Pushing ax,bx,cx,dx
        ;Set Settings
...
;=============================================================================
		...
		Again:
		 ...
		 proc CheckRandom
				Lastsquad			;get last squad pointer
				 mov bx,offset arr.x
				 sub bx,11
			checkrand:
					add bx,11
...
;=============================================================================
		...
		;Check if the apple was touched by the snake
			add [randX],3
			add [randY],3
            GetPixelColor [randX],[randY]		;get color of the middle of the apple
			sub [randX],3
			sub [randY],3
            cmp al,[colorsnake]
            je Apple_Touch
		...
		;Print A Tail For Snake By set the settings of new squad betehem lsquad akodem
            ...
            con:
				...
				add [endRandX],3
				add [endRandY],3
				PrintSnake [randX],[randY],[endRandX],[endRandY],0 
			;Put NEW Apple
				call Random_Values
				Random_Into_Variables
				PrintSnake [randX],[randY],[endRandX],[endRandY],4  
...
;=============================================================================
		...
		;Set all the numbers to their ascii code to present them 
			...
			;compare if si point to the first digit
				...
				jmp condis
				printspace:
					set_Cursor_Position [squad], 30	;set new position to cursor
				...
				downline:
					add [squad],2
					set_Cursor_Position [squad],23	;cursor down one line
				condis:
...
;=============================================================================
		...
		;Displaying score and title
            String_Color 14,1,0,4,70
            String_Color 6,5,0,8,70
            set_Cursor_Position 1,0
            Print_String g
            String_Color 00000100b,8,29,9,70
            set_Cursor_Position 8,29
            Print_String Present_Score
            call PRINT_NUMBER					;Print Score Itself
		;Displaying all the get name stuff
			String_Color 01111111b,11,33,11,48
            set_Cursor_Position 11,16
            Print_String Enter_Name
            String_Color 14,18,2,24,70
            set_Cursor_Position 18,2
            Print_String GameOver_Instructions
            set_Cursor_Position 11,34
        ...
        ;Get Input - username
			writename:
				set_Cursor_Position 13,16
				String_Color [squad],13,16,14,70
				Print_String notelength
				set_Cursor_Position 11,[postemp]	
				...
				String_Length	;get names length
				cmp cx,0		
		...
		;Displaying score and title
            ...
            Print_String Present_Score
            call PRINT_NUMBER				;Print Score Itself
			set_Cursor_Position 17,22
			String_Color 15,17,22,25,70
			Print_String PressAny
        ...
        ;Print Name,Score,and title
            String_Color 11,1,0,4,70
            String_Color 15,5,0,7,70
            set_Cursor_Position 1,0
            Print_String s
               
            String_Color 5,8,23,9,70
            set_Cursor_Position 8,23
            Print_String Name_String
            String_Color 5,8,50,9,70
            set_Cursor_Position 8,50
            Print_String Score_String
		...
		proc InstructionBoard
			...
			String_Color 14,1,0,4,78
			String_Color 15,4,0,6,78
			set_Cursor_Position 1,0
			Print_String i
			set_Cursor_Position 8,6
			String_Color 15,8,6,23,70
			Print_String Instruction_Text
		...
		;Displaying options to the user
			...
			String_Color 15,2,0,4,70
			String_Color 10,5,0,9,70
			Print_String o
			String_Color 15,10,26,12,70
            set_Cursor_Position 13,26
			String_Color 15,13,26,24,70
			Print_String OpenScreen_Instruction
