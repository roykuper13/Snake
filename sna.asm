...
;=================================================================                                                                                                    
    struc snake_node
        x dw ?              ;start x point of node
        y dw ?              ;start y point of node
        endx dw ?           ;end x point of node
        endy dw ?           ;end y point of node
...
;=================================================================
        ...
        arr snake_node 5000 dup (?)                         ;Array Of Squads of snake
